...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-xl border border-[#cbd5e1] bg-white px-4 py-3 text-sm text-[#1e293b] ring-offset-background placeholder:text-[#94a3b8] transition-all duration-200 focus:outline-none focus:border-[#8CC63F] focus:ring-4 focus:ring-[#8CC63F]/15 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 cursor-pointer shadow-xs",
      className
    )}
    {...props}
  >
